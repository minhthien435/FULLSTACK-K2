...
function drawRandomCard(){
    //tao mot so ngau nhien tu 0 den chieu dai cuam nga
    ...
    // cap nhat nut bam
    drawBtn.textContent="Rút thêm lá nữa";
    endBtn.style.display="inline-block";

}
function endSession(){
    //dặt lại giao diện về ban đầu
    cardName.textContent="Phiên bói bài đã kết thúc";
    cardDescription.textContent="Cảm ơn bạn đã sử dụng."
    //ẩn hiên nút 
    drawBtn.textContent="Bắt đầu lại";
...
// xay dung chuc nang back to top
...
// web component : Chia nho cac thanh phan trang web thanh cac the html rieng biet de dang tai su dung
/* 
header footer product
Khi nao can tach web component
su dung o nhieu noi
Linh hoat chi can goi the html
Logic,giao dien phuc tap
- Vong doi cua mot componet duoc tao ra khi no bi loai bo khoi DOM
- khoi tao
- cap nhat
- Loai bo
